...
export default {
    ...
    data() {
        return {
            ...
            isEditMode: false
                                    ...
                                    //calling fetchUserProfile() function, which makes HTTP requets to the backend
                                    // backend then send back the userdata. We then set/update the components state with the user data
        }
    },
    async created(){
    ...
    methods: {
        ...
        const res = await fetch('update-profile', {
            method: "POST",
            headers: {
                // We are receiving information inform of JSON
                'Accept': 'application/json',
                //We are also sending the information in JSON form
